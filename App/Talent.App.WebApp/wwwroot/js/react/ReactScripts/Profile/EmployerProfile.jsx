...
export default class EmployeeProfile extends React.Component {
    ...
    loadData() {
        ...
        $.ajax({
            url: 'https://talentservicesprofile20200210012741.azurewebsites.net/profile/profile/getEmployerProfile',
            headers: {
            ...
            success: function (res) {
                console.log(res.employer.companyContact.name)
    ...
    saveData() {
        ...
        var cookies = Cookies.get('talentAuthToken');
        $.ajax({
            url: 'https://talentservicesprofile20200210012741.azurewebsites.net/profile/profile/saveEmployerProfile',
            headers: {
                'Authorization': 'Bearer ' + cookies,
                'Content-Type': 'application/json'
            },
